from yolo.yolov1_net import YOLONet
from yolo.pacal_voc_reader import pascal_voc
...
if __name__ == '__main__':
    ...
    # with open('../Total_data/pascal_voc/cache/pascal_train_gt_labels.pkl', 'rb') as f:
    #     gt_labels = pickle.load(f)
    #     print(len(gt_labels))
    #     for vec in gt_labels:
    #         print(vec)
    a=[0,1,2,3,4,5,6,7]
    print(a)
    print(a[:, ::-1, :])
    ...
    # parser.add_argument('--data_dir', default='../Total_Data/', type=str)
